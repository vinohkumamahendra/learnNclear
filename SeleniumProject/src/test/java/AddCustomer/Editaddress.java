...
public class Editaddress {
	...
	@Parameters({"browser"})
	@Test
	public void mEditCustomer(String browser) throws Exception {	
//		RemoteWebDriver driver = null;
		reports = new ExtentReports("Reports/LearnNClear.html");
		reports.addSystemInfo("Testing", "Automation testing");
		reports.loadConfig(new File("extent2.xml"));
		test = reports.startTest("Create User");
		a= new SeleniumUtility();
		a.launchBrowserAndLoadURL(browser, "http://learnnshine.com/drupal/node/add/customers");
		...
		a.TakeScreenshot("Screenshot/creat.png");
		test.log(LogStatus.PASS, "Vignesh Created Successfully" + test.addScreenCapture(System.getProperty("user.dir") + "/Screenshot/creat.png"));
		a.OpenURL("http://www.learnnshine.com/drupal/manage-customers");
		...
		a.Ale();
		a.pause(3000);
		a.TakeScreenshot("Screenshot/update.png");
		test.log(LogStatus.PASS, "Vignesh Updated Successfully" + test.addScreenCapture(System.getProperty("user.dir") + "/Screenshot/update.png"));
